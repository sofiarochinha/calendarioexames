...
<head>
    ...
    <title>UACalendário | Configurar disciplinas</title>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-is-opening menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/configuracoes/disciplinas" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Disciplinas</p>
                                </a>
                            </li>
                                    ...
                                    <table class="table-bordered col-md-12">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="col-md-4"><select style="border:0; width:100%;" disabled/><option class="text-center">Rita Santos</option></select></td>
